...
\def\titel{Absorption and Diffraction \\[0,5cm] of X-Ray Radiation} % Absatz mit \\[0,5cm]
\def\bottom{SS2023}
\def\datum{24.05.2023}
\def\platz{NWII | 2.2.01.489}
\def\betreuer{Harshit Agarwal}
