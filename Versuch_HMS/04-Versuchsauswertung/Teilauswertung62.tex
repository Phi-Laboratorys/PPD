...
\begin{center}
    ...
    \captionof{figure}{Vergleich zwischen Theorie und Praxis für gemessene Werte am Spekturmanalysator mit $P^*_\mathrm{R,Theo}$ = -77\,dBm und $P^*_\mathrm{S,Theo}$= -22\,dBm, sowie Vergleich zwischen $P^*_\mathrm{S,Mess}$ und $P^* _\mathrm{I}$}
