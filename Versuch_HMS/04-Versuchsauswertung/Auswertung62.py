...
plt.errorbar(dfspec["w_m/MHz"], dfspec["P_S/dBm"], dfspec["s_Ps/dBm"], marker = "o", linestyle = "", capsize=3, label = r"$P_\mathrm{S,Mess}$")
plt.errorbar(dfspec["w_m/MHz"], dfspec["P_R/dBm"], dfspec["s_Pr/dBm"], marker = "o", linestyle = "", capsize=3, label = r"$P_\mathrm{R,Mess}$")
...
plt.errorbar(dfspec["w_m/MHz"], dfspec["P_S/dBm"], dfspec["s_Ps/dBm"], marker = "o", linestyle = "", capsize=3, label = r"$P_\mathrm{S,Mess}$")
plt.errorbar(dfspec["w_m/MHz"], dfspec["P_R/dBm"], dfspec["s_Pr/dBm"], marker = "o", linestyle = "", capsize=3, label = r"$P_\mathrm{R,Mess}$")
plt.errorbar(dfvlust["w_m/MHz"], dfvlust["P_I*/dBm"], dfvlust["s_Pi*/dBm"], marker = "o", linestyle = "", capsize=3, label = r"$P_\mathrm{I}^*$")
