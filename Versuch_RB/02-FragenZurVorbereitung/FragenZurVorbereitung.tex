...
\begin{figure}[htb]
    \centering\includegraphics[width=0.9\textwidth]{FzV/Electromagnetic_spectrum_-de.pdf}
...
\begin{figure}[htb]
    \centering\includegraphics[width=0.4\textwidth]{FzV/emission_roehre.pdf}
...
\begin{figure}[htb]
    \centering\subfigure[Energie]{\includegraphics[width=0.47\textwidth]{FzV/Energie_genau.pdf}}
    \subfigure[Wellenlänge]{\includegraphics[width=0.47\textwidth]{FzV/Wellenlaenge_genau.pdf}}
